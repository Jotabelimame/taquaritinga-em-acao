...
FOTOS_MATHILDE = "https://photos.app.goo.gl/vfUG8JBz7uq3tcDv9"

for loc in locais:
    if loc["id"] == 20 or "mathilde menon" in loc["nome"].lower():
        loc["nome"] = "EMEB Mathilde Menon"
        loc["linkFotos"] = FOTOS_MATHILDE
        loc["fotos"] = FOTOS_MATHILDE
        loc["status"] = "concluido"
        print(f"Atualizado Local #{loc['id']}: {loc['nome']} -> Status: CONCLUIDO | Fotos: {FOTOS_MATHILDE}")
...
print("\n=== EMEB MATHILDE MENON ATUALIZADA ===")
